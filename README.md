...
This method has been verified to work on Ubuntu & Mac OS-X:
...
Explore commands in the makefile by running simply `make` or `make help`:

```bash
❯ make help
examples      Generate documentation for scripts in the examples folder
